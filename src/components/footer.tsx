            ...
            <div className='w-full md:mt-[124px] mt-16 flex md:flex-row flex-col justify-between md:gap-7 gap-8'>
                <div ref={socialRef} className='w-full flex flex-col justify-between'>
                    <div className='relative cursor-pointer w-fit group touch-manipulation'>
                        ...
                        <Image src={UserImg} alt="User" width={100} height={100} className="z-[1] w-[110px] h-[166px] object-cover absolute top-6 md:left-[80%] right-0 opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-300" />
                    </div>
                    <div className='relative cursor-pointer w-fit group touch-manipulation'>
                        <h1 className='text-lime-green font-nichrome font-bold md:text-[96px] text-[58px] uppercase leading-18'>
                            LINKEDIN
                        </h1>
                        <Image src={UserImg} alt="User" width={100} height={100} className="z-[1] w-[110px] h-[166px] object-cover absolute top-6 md:left-[45%] right-0 opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-300" />
                    </div>
                </div>
