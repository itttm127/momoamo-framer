            ...
            <main className="w-full h-full md:mt-10 mt-[18px] md:px-0 px-4">
                <div className="w-full h-[28%]">
                    <div ref={lettersRef} className="flex justify-center items-center md:gap-1 gap-0 relative z-[1]">
                        ...
                        <div className='letter_animation flex justify-center items-center md:gap-1 gap-0 relative z-[1]'>
                            {/* O */}
                            <Image src={O_Svg} alt="O" width={192} height={191} className="hero-letter h-12 md:h-48 w-auto" />
                            ...
                            {/* A */}
                            <Image src={A_Svg} alt="A" width={146} height={187} className="hero-letter h-12 md:h-48 w-auto" />
                        ...
                        {/* R */}
                        <Image src={R_Svg} alt="R" width={44} height={46} className="hero-letter h-3 md:h-11 w-auto" />
                    </div>
                    ...
                    <div ref={imagesRef} className='w-full h-full'>
                        <Image src={HouseImage.src} alt="House" width={355} height={533} className="hero-image md:w-[355px] md:h-[533px] w-[219px] h-[329px] object-cover absolute md:right-[56px] md:bottom-[132px] -right-[20px] bottom-[377px] opacity-0" />
                        <Image src={User1Image.src} alt="User 1" width={162} height={243} className="hero-image md:w-[162px] md:h-[243px] w-[129px] h-[193px] object-cover absolute md:bottom-[314px] md:left-[183px] bottom-[118px] left-0 z-[2] opacity-0" />
                        <Image src={User2Image.src} alt="User 2" width={206} height={309} className="hero-image md:w-[206px] md:h-[309px] w-[164px] h-[245px] object-cover absolute md:bottom-[61px] md:left-[231px] -bottom-[50px] left-[31px] z-[1] opacity-0" />
                        <Image src={User3Image.src} alt="User 3" width={201} height={250} className="hero-image absolute bottom-0 left-0 w-[201px] h-[250px] object-cover md:block hidden opacity-0" />
                    </div>
                </div>
            </main>
        </section>
